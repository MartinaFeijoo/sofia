...
void Zproduction(const Float_t nev = -1)
{
  ...
  // INPUT FILE
  TString filename = "s515_runId0484_data_offline_20211103_111157.root";
  ...
  for (int i=0; i<4; i++)
  {
    ...
    hlos[i] = new TH2F("hlos",htitle_char,500,2.45,2.51,500,45,53);
    hmusicAq[i] = new TH2F("hmusicAq",htitle_char,500,2.45,2.51,500,45,53);
    hmusic[i] = new TH1F("hmusic",htitle_char,500,42,54);
  }
